                    ...
                    <form method="post" action="{{route('material.store')}}">
                      ...
                      <div class="form-group">
                        <label for="opening_balance">Opening Balance</label>
                         <input id="opening_balance" type="text" class="form-control @error('opening_balance') is-invalid @enderror" name="opening_balance" value="{{ old('opening_balance') }}" required autocomplete="opening_balance" autofocus>
